...
<c:url value="/categories/records" var="recordsUrl"/>
<c:url value="/categories/create" var="addUrl"/>
<c:url value="/categories/update" var="editUrl"/>
<c:url value="/categories/delete" var="deleteUrl"/>
...
<head>
		...
		$("#grid").jqGrid({
			...
			mtype: 'GET',
		   	...
		   	colModel:[
		   		...
		   		{name:'categoryName',index:'categoryName', width:100, editable:true, editrules:{required:true}, editoptions:{size:10}}
		   	],
		   	postData: {},
			rowNum:10,
		   	rowList:[10,20,40,60],
	...
	function addRow() {
   		$("#grid").jqGrid('setColProp', 'categoryName', {editoptions:{readonly:false, size:10}});
