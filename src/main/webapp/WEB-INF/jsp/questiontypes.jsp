...
<c:url value="/questiontypes/records" var="recordsUrl"/>
<c:url value="/questiontypes/create" var="addUrl"/>
<c:url value="/questiontypes/update" var="editUrl"/>
<c:url value="/questiontypes/delete" var="deleteUrl"/>
...
<head>
	...
	<!-- <title>Question Type Records</title>  -->
	...
	$(function() {
		$("#grid").jqGrid({
			...
			datatype: 'json',
			mtype: 'GET',
		   	colNames:['Id', 'Question Type'],
		   	colModel:[
		   		{name:'id',index:'id', width:55, editable:false, editoptions:{readonly:true, size:10}, hidden:true},
		   		{name:'questionTypeName',index:'questionTypeName', width:100, editable:true, editrules:{required:true}, editoptions:{size:10}}
		   	],
		   	postData: {},
			rowNum:10,
		   	rowList:[10,20,40,60],
	...
	function addRow() {
   		$("#grid").jqGrid('setColProp', 'questionTypeName', {editoptions:{readonly:false, size:10}});
