...
<c:url value="/difficulties/records" var="recordsUrl"/>
<c:url value="/difficulties/create" var="addUrl"/>
<c:url value="/difficulties/update" var="editUrl"/>
<c:url value="/difficulties/delete" var="deleteUrl"/>
...
<head>
	...
	<!-- <title>Difficulty Records</title>  -->
	...
	$(function() {
		$("#grid").jqGrid({
			...
			datatype: 'json',
			mtype: 'GET',
		   	colNames:['Id', 'Difficulty'],
		   	colModel:[
		   		{name:'id',index:'id', width:55, editable:false, editoptions:{readonly:true, size:10}, hidden:true},
		   		{name:'difficultyName',index:'difficultyName', width:100, editable:true, editrules:{required:true}, editoptions:{size:10}}
		   	],
		   	postData: {},
			rowNum:10,
		   	rowList:[10,20,40,60],
	...
	function addRow() {
   		$("#grid").jqGrid('setColProp', 'difficultyName', {editoptions:{readonly:false, size:10}});
