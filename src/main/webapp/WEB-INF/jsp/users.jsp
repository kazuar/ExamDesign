	...
	$(function() {
		$("#grid").jqGrid({
			...
			mtype: 'GET',
		   	...
		   	colModel:[
		   		...
		   		{name:'role',index:'role', width:50, editable:true, editrules:{required:true}, 
		   			...
		   			editoptions:{value:"1:Admin;2:Regular1"},
		   			formatoptions:{value: "1:Admin;2:Regular2"}, 
		    ...
		    beforeProcessing: function(data) {
		    	$("#grid").setColProp('role', { 
		    		editoptions:{value: data.map.roles},
		    		formatoptions:{value: data.map.roles}, 
		    		searchoptions: {sopt:['eq'], value: ":;" + data.map.roles}});
		    },
